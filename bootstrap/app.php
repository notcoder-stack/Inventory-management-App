...
foreach ([$_overrideStorage . '/bootstrap/cache', $_overrideStorage . '/framework/sessions', $_overrideStorage . '/framework/views', $_overrideStorage . '/framework/cache'] as $_dir) {
    if (!is_dir($_dir)) {
